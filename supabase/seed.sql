...
-- Feriados nacionales de Venezuela (CEB-115). El documento no tiene pestaña de
-- dias no habiles, asi que viven aqui. Carnaval y Semana Santa salen de la
-- Pascua: 5 de abril de 2026 y 28 de marzo de 2027.
insert into dia_no_habil (desde, hasta, descripcion) values
  ('2026-10-12', '2026-10-12', 'Día de la Resistencia Indígena'),
  ('2026-12-24', '2026-12-25', 'Navidad'),
  ('2026-12-31', '2027-01-01', 'Fin de año'),
